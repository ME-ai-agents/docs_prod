...
|-----------|-------|-------|
| **Organization Size** | 5,000 employees | Mid-sized enterprise |
| **Annual Revenue** | $1.2 billion | Technology or financial services sector |
| **IT Environment** | 8,500 devices | Includes workstations, mobile devices, and servers |
| **Annual IT Support Tickets** | 62,000 | ~12.4 tickets per employee annually |
| **IT Support Staff** | 52 FTEs | L1: 30, L2: 15, L3: 7 |
| **Customer Service Staff** | 65 FTEs | Handling internal and external customer support |
